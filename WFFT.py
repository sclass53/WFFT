        ...
        if requesttype == "login":
            ...
            if psw == QSettings('Bruhsoft', 'WFFT').value('transmitter/login_password', "1234"):
                ...
                cookie = {
                    ...
                    "password": "{}".format(
                        QSettings('Bruhsoft', 'WFFT').value('transmitter/login_password', "1234"))}
    ...
    def judge_cookie(self):
        try:
            ...
            if "p2iix9ab" in cookiedict.keys() and "p9az" in cookiedict.keys():
                decode = str.maketrans("i91x4bpv2cytol7aw5szhjr3gkd6mn8eufq", "so3wudphankvigbrq85t94lm71jf6cyzx2e")
                setting = QSettings('Bruhsoft', 'WFFT')
...
class WebFilesTransmitter_infolabel(QLabel):
    ...
    def __init__(self, parent: QGroupBox):
        ...
        self.qrcode_label.setGeometry(700, 0, 180, 180)
        pix = QPixmap(200, 200)
    ...
    def paintEvent(self, e) -> None:
        ...
        s = 50
        d = 30
        painter.drawText(10, s - 30, "共享路径:")
        painter.drawText(10, s, "{}".format(self.sharepath))
        painter.drawText(10, s + 15 + d, "网络适配器:")
        painter.drawText(10, s + 15 + d * 2, "IP:{}  端口:{}".format(self.ip, self.port))
        painter.drawText(10, s + 30 + d * 3, "链接:")
        painter.drawText(10, s + 30 + d * 4, "{}".format(self.url))
        painter.setPen(QPen(Qt.red, 3, Qt.SolidLine))
        painter.drawText(10, s + 50 + d * 4, 240, 200, Qt.TextWordWrap,
...
class WebFilesTransmitterBox(QGroupBox):
    ...
    def __init__(self, WebFilesTransmitter: WebFilesTransmitter, text="", parent=None):
        ...
        self.transmitter_web_allowupload.setChecked(
            QSettings('Bruhsoft', 'WFFT').value('transmitter/allowupload', True, type=bool))
        ...
        def allowuploadchange(a):
            ...
            QSettings('Bruhsoft', 'WFFT').setValue('transmitter/allowupload',
        ...
        def need_loginchange(a):
            ...
            QSettings('Bruhsoft', 'WFFT').setValue('transmitter/need_login',
        ...
        self.transmitter_web_need_login_label.setGeometry(self.transmitter_web_need_login.x(),
                                                          ...
                                                          self.transmitter_web_need_login.width() - 5, 30)
        self.transmitter_web_need_login_label.setPlaceholderText("1234")
        self.transmitter_web_need_login_label.textChanged.connect(
            lambda x: QSettings('Bruhsoft', 'WFFT').setValue('transmitter/login_password', x if len(x) else "1234"))
        self.transmitter_web_need_login_label.setText(
            QSettings('Bruhsoft', 'WFFT').value('transmitter/login_password',
                                                "1234"))
        need_loginchange(QSettings('Bruhsoft', 'WFFT').value('transmitter/need_login', True, type=bool))
        ...
        def choicefiles():
            ...
            if len(files):
                ...
                QSettings('Bruhsoft', 'WFFT').setValue('transmitter/sharepath', os.path.split(files[0])[0])
        ...
        def choicedir():
            ...
            if len(dir):
                ...
                QSettings('Bruhsoft', 'WFFT').setValue('transmitter/sharepath', dir)
        ...
        self.transmitter_web_choice_files.setGeometry(165, 35, 140, 40)
        ...
        self.transmitter_web_devices.setGeometry(165, 130, 140, 50)
        ...
        d = QSettings('Bruhsoft', 'WFFT').value('transmitter/sharepath', "")
        if d != "":
